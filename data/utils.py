...
"""
def read_resample(audio_path, sr=160000, audio_limit_len=None):
    ...
    if audio_type == 'mp3':
        ...
        raise Exception("unsupported file type: " + audio_type)
